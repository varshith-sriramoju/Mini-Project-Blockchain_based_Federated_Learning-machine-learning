...
--
-- Database: `blockchain_based_federated_learning`
--
CREATE DATABASE IF NOT EXISTS `blockchain_based_federated_learning` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `blockchain_based_federated_learning`;
...
('1x81riodgkqqrjilmz8v81q4m5ncd4d0', 'eyJ1c2VyaWQiOjJ9:1qWcXw:K_125Nixp6-xoXp0LzPOvcKPddRsuhpJA59SnyWNgmg', '2023-08-31 12:56:16.114666'),
...
('9fw2qvxxodaf6ei1wdr182hm3nbxxm4x', 'eyJ1c2VyaWQiOjF9:1qWatj:w41UaaDim3RFbC19fzjHhlkBP3LN5NzixFYbcT5mlE8', '2023-08-31 11:10:39.797821'),
...
(1, 'Arvind', 'Arvind123@gmail.com', 'Arvind', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(11, 'Convolutional Neural Network (CNN)', '53.333333333333336'),
(12, 'SVM', '56.666666666666664'),
(13, 'Logistic Regression', '50.0'),
(14, 'Decision Tree Classifier', '56.666666666666664');
...
(7, 'No Poisoning Attack Found', '66.66666666666666'),
(8, 'Poisoning Attack Found', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_poisoning_attack`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_poisoning_attack` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `anaemia` varchar(300) NOT NULL,
  `creatinine_phosphokinase` varchar(300) NOT NULL,
  `diabetes` varchar(300) NOT NULL,
  `ejection_fraction` varchar(300) NOT NULL,
  `high_blood_pressure` varchar(300) NOT NULL,
  `platelets` varchar(300) NOT NULL,
  `serum_creatinine` varchar(300) NOT NULL,
  `serum_sodium` varchar(300) NOT NULL,
  `sex` varchar(300) NOT NULL,
  `smoking_history` varchar(300) NOT NULL,
  `bmi` varchar(300) NOT NULL,
  `HbA1c_level` varchar(300) NOT NULL,
  `blood_glucose_level` varchar(300) NOT NULL,
  `blockchain_code_sha` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `remote_user_detect_poisoning_attack`
--

INSERT INTO `remote_user_detect_poisoning_attack` (`id`, `Fid`, `age`, `anaemia`, `creatinine_phosphokinase`, `diabetes`, `ejection_fraction`, `high_blood_pressure`, `platelets`, `serum_creatinine`, `serum_sodium`, `sex`, `smoking_history`, `bmi`, `HbA1c_level`, `blood_glucose_level`, `blockchain_code_sha`, `Prediction`) VALUES
(1, '10.42.0.42-104.193.88.109-43930-80-6', '42', '1', '250', '1', '15', '0', '213000', '1.3', '136', '0', 'not current', '27.32', '5.7', '145', '4c96d9cfc6da83e41b0889579d1e8b25765bd355', 'Poisoning Attack Found'),
(2, '182.22.25.252-10.42.0.211-443-38738-6', '59', '1', '280', '1', '25', '1', '302000', '1', '141', '1', 'No Info', '21.25', '6.1', '200', '9da357734a3bfc5b51dc2c63b6b4ab28930767ab', 'No Poisoning Attack Found'),
(3, '172.217.10.42-10.42.0.42-443-54275-6', '45', '0', '582', '0', '35', '0', '385000', '1', '145', '1', 'former', '27.32', '6', '159', 'd3493e82bfbb4d2dad1a01b5c2bb50df879619a7', 'No Poisoning Attack Found');
